...
module.exports = {
    ...
    async findAllCategories() {
        return sequelize.query("SELECT SUM(depenses.montant) AS TOTAL, categories.nom FROM depenses JOIN categories ON depenses.IDCategorie = categories.ID GROUP BY depenses.IDCategorie;")
            .then(data => {
                console.log(chalk.green("Les dépenses ont toutes été retournées avec succès !"));
                return data;
            })
